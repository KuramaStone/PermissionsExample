...
public class AddPermGroupCommand extends SubCommand {
    public AddPermGroupCommand(PermissionsApi api, SubCommand parent, int argumentLocation, String subcommand) {
