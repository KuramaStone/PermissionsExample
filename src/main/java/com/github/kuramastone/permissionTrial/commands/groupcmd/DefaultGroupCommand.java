...
public class DefaultGroupCommand extends SubCommand {
    public DefaultGroupCommand(PermissionsApi api, SubCommand parent, int argumentLocation, String subcommand) {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        api.setDefaultGroup(api.getGroupByName(groupName));
